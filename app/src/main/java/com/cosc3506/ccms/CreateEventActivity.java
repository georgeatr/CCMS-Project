...
public class CreateEventActivity extends AppCompatActivity {
    ...
    public void createEvent(View view){
        ...
        if(     newEventName.isEmpty() ||
            ...
            Event e = new Event(newEventLocation, newEventDescription, newEventName, newEventID, newEventStartDateTime, newEventBudget, newEventEndDateTime, newEventCapacity);
            club.newEvent(e);
